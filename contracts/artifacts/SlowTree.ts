...
export class SlowTreeContract extends ContractBase {
  ...
  public static deploy(wallet: Wallet, ) {
    return new DeployMethod<SlowTreeContract>(Point.ZERO, wallet, SlowTreeContractArtifact, SlowTreeContract.at, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKey(publicKey: PublicKey, wallet: Wallet, ) {
    return new DeployMethod<SlowTreeContract>(publicKey, wallet, SlowTreeContractArtifact, SlowTreeContract.at, Array.from(arguments).slice(2));
  }
